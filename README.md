...
Les cadres noirs délimitent les zones où chacun des deux bras peut se déplacer, et les symboles ![émetteur](frontend/assets/emitter.png){width=2em background-color=gray} en noir symbolysent la position actuelle de chaque bras.
