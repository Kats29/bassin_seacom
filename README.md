...
Les cadres noirs délimitent les zones où chacun des deux bras peut se déplacer, et les symboles <img src="frontend/assets/emitter.png" width="150"> en noir symbolysent la position actuelle de chaque bras.
