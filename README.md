...
Les cadres noirs délimitent les zones où chacun des deux bras peut se déplacer, et les symboles <span style="background-color='gray'"><img src="frontend/assets/emitter.png" width="20"></span> en noir symbolysent la position actuelle de chaque bras.
